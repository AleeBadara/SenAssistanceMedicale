        ...
        <div>
            <div className="pimg3">
                <div className="section_title">
                    <span className="border">Evacuation sanitaire</span>
                </div>
            </div>

            <section className="section">
                <h2>Transport sanitaire </h2>
                <p className="textDescription">
                    Evacuation sanitaire à l'intérieur comme à l'extérieur du pays. <br />Sed ut perspiciatis unde omnis iste natus error sit voluptatem
